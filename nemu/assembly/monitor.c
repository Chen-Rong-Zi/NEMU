...
# 1 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/paddr.h" 1
# 26 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/paddr.h"
uint8_t* guest_to_host(paddr_t paddr);

paddr_t host_to_guest(uint8_t *haddr);

static inline 
# 30 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/paddr.h" 3 4
             _Bool 
# 30 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/paddr.h"
...
static void welcome() {
  do { printf("\33[1;34m" "[%s:%d %s] " "Trace: %s" "\33[0m" "\n", "src/monitor/monitor.c", 28, __func__, "\33[1;32m" "ON" "\33[0m"); do { extern FILE* log_fp; extern 
# 28 "src/monitor/monitor.c" 3 4
 _Bool 
# 28 "src/monitor/monitor.c"
 log_enable(); if (log_enable() && log_fp != 
# 28 "src/monitor/monitor.c" 3 4
 ((void *)0)
# 28 "src/monitor/monitor.c"
 ) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "Trace: %s" "\33[0m" "\n", "src/monitor/monitor.c", 28, __func__, "\33[1;32m" "ON" "\33[0m"); fflush(log_fp); } } while (0); } while (0);
  do { printf("\33[1;34m" "[%s:%d %s] " "If trace is enabled, a log file will be generated " "to record the trace. This may lead to a large log file. " "If it is not necessary, you can disable it in menuconfig" "\33[0m" "\n", "src/monitor/monitor.c", 29, __func__); do { extern FILE* log_fp; extern 
...
# 29 "src/monitor/monitor.c" 3 4
 ((void *)0)
# 29 "src/monitor/monitor.c"
 ) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "If trace is enabled, a log file will be generated " "to record the trace. This may lead to a large log file. " "If it is not necessary, you can disable it in menuconfig" "\33[0m" "\n", "src/monitor/monitor.c", 29, __func__); fflush(log_fp); } } while (0); } while (0)

                                                                    ;
  do { printf("\33[1;34m" "[%s:%d %s] " "Build time: %s, %s" "\33[0m" "\n", "src/monitor/monitor.c", 32, __func__, "17:24:01", "Jan 17 2025"); do { extern FILE* log_fp; extern 
...
# 32 "src/monitor/monitor.c" 3 4
 ((void *)0)
# 32 "src/monitor/monitor.c"
 ) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "Build time: %s, %s" "\33[0m" "\n", "src/monitor/monitor.c", 32, __func__, "17:24:01", "Jan 17 2025"); fflush(log_fp); } } while (0); } while (0);
...
# 41 "src/monitor/monitor.c" 2


# 42 "src/monitor/monitor.c"
void sdb_set_batch_mode();

char *elf_file = 
# 44 "src/monitor/monitor.c" 3 4
                ((void *)0)
# 44 "src/monitor/monitor.c"
                    ;
...
static long load_img() {
  if (img_file == 
# 51 "src/monitor/monitor.c" 3 4
                 ((void *)0)
# 51 "src/monitor/monitor.c"
                     ) {
    do { printf("\33[1;34m" "[%s:%d %s] " "No image is given. Use the default build-in image." "\33[0m" "\n", "src/monitor/monitor.c", 52, __func__); do { extern FILE* log_fp; extern 
...
# 52 "src/monitor/monitor.c" 3 4
   ((void *)0)
# 52 "src/monitor/monitor.c"
   ) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "No image is given. Use the default build-in image." "\33[0m" "\n", "src/monitor/monitor.c", 52, __func__); fflush(log_fp); } } while (0); } while (0);
    return 4096;
  }

  FILE *fp = fopen(img_file, "rb");
  do { if (!(fp)) { (fflush(
# 57 "src/monitor/monitor.c" 3 4
 stdout
# 57 "src/monitor/monitor.c"
 ), fprintf(
# 57 "src/monitor/monitor.c" 3 4
 stderr
# 57 "src/monitor/monitor.c"
...
# 57 "src/monitor/monitor.c"
 "fp"
# 57 "src/monitor/monitor.c" 3 4
 , "src/monitor/monitor.c", 57, __extension__ __PRETTY_FUNCTION__); }))
# 57 "src/monitor/monitor.c"
 ; } } while (0);
...
# 59 "src/monitor/monitor.c"
  ...
  do { printf("\33[1;34m" "[%s:%d %s] " "The image is %s, size = %ld" "\33[0m" "\n", "src/monitor/monitor.c", 62, __func__, img_file, size); do { extern FILE* log_fp; extern 
# 62 "src/monitor/monitor.c" 3 4
 _Bool 
# 62 "src/monitor/monitor.c"
 log_enable(); if (log_enable() && log_fp != 
# 62 "src/monitor/monitor.c" 3 4
 ((void *)0)
# 62 "src/monitor/monitor.c"
 ) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "The image is %s, size = %ld" "\33[0m" "\n", "src/monitor/monitor.c", 62, __func__, img_file, size); fflush(log_fp); } } while (0); } while (0);
...
# 66 "src/monitor/monitor.c"
 "ret == 1"
# 66 "src/monitor/monitor.c" 3 4
 , "src/monitor/monitor.c", 66, __extension__ __PRETTY_FUNCTION__); }))
# 66 "src/monitor/monitor.c"
                 ;
...
static int parse_args(int argc, char *argv[]) {
  const struct option table[] = {
    {"batch" , 
# 74 "src/monitor/monitor.c" 3 4
                 0 
# 74 "src/monitor/monitor.c"
                                  , 
# 74 "src/monitor/monitor.c" 3 4
                                    ((void *)0)
# 74 "src/monitor/monitor.c"
                                        , 'b'},
    {"log" , 
# 75 "src/monitor/monitor.c" 3 4
                 1
# 75 "src/monitor/monitor.c"
                                  , 
# 75 "src/monitor/monitor.c" 3 4
                                    ((void *)0)
# 75 "src/monitor/monitor.c"
                                        , 'l'},
    {"diff" , 
# 76 "src/monitor/monitor.c" 3 4
                 1
# 76 "src/monitor/monitor.c"
                                  , 
# 76 "src/monitor/monitor.c" 3 4
                                    ((void *)0)
# 76 "src/monitor/monitor.c"
...
# 80 "src/monitor/monitor.c"
  ...
  while ( (o = getopt_long(argc, argv, "-bhl:d:p:e:", table, 
# 84 "src/monitor/monitor.c" 3 4
                                                            ((void *)0)
# 84 "src/monitor/monitor.c"
                                                                )) != -1) {
    switch (o) {
      ...
      default:
        ...
        printf("\t-e,--elf=FILE           read customer program elf\n");
        printf("\n");
        exit(0);
    }
  }
