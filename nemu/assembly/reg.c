...
# 38 "src/isa/riscv32/reg.c" 3 4
                                     _Bool 
# 38 "src/isa/riscv32/reg.c"
                                          *success) {
    ...
    {
        *success = 
# 43 "src/isa/riscv32/reg.c" 3 4
                  1
# 43 "src/isa/riscv32/reg.c"
                      ;
        return 0;
    }
    ...
    {
        *success = 
# 48 "src/isa/riscv32/reg.c" 3 4
                  1
# 48 "src/isa/riscv32/reg.c"
                      ;
        return cpu.pc;
    }
    else if ( strcmp("$mstatus", s) == 0 )
    {
        *success = 
# 53 "src/isa/riscv32/reg.c" 3 4
                  1
# 53 "src/isa/riscv32/reg.c"
                      ;
        return cpu.csrs.mstatus;
    }
    else if ( strcmp("$mepc", s) == 0 )
    {
        *success = 
# 58 "src/isa/riscv32/reg.c" 3 4
                  1
# 58 "src/isa/riscv32/reg.c"
                      ;
        return cpu.csrs.mepc;
    }
    else if ( strcmp("$mtvec", s) == 0 )
    {
        *success = 
# 63 "src/isa/riscv32/reg.c" 3 4
                  1
# 63 "src/isa/riscv32/reg.c"
                      ;
        return cpu.csrs.mtvec;
    }
    else if ( strcmp("$mcause", s) == 0 )
    {
        *success = 
# 68 "src/isa/riscv32/reg.c" 3 4
                  1
# 68 "src/isa/riscv32/reg.c"
                      ;
        return cpu.csrs.mcause;
    }
    ...
    for ( int i = 0; i < 32; i += 1 )
    {
        ...
        for ( int j = 1; s[j] != '\0'; j += 1 )
            name[j - 1] = s[j];

        if ( strcmp(name, regs[i]) == 0 )
        {
            *success = 
# 83 "src/isa/riscv32/reg.c" 3 4
                      1
# 83 "src/isa/riscv32/reg.c"
                          ;
            return cpu.gpr[i];
        }
    }
    *success = 
# 87 "src/isa/riscv32/reg.c" 3 4
              0
# 87 "src/isa/riscv32/reg.c"
                   ;
    return 0;
}
