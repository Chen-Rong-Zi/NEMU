...
__attribute__((visibility("default"))) void difftest_memcpy(paddr_t addr, void *buf, size_t n, 
# 21 "src/cpu/difftest/ref.c" 3 4
                                                                _Bool 
# 21 "src/cpu/difftest/ref.c"
                                                                     direction) {
  
# 22 "src/cpu/difftest/ref.c" 3 4
 ((void) sizeof ((
# 22 "src/cpu/difftest/ref.c"
 0
# 22 "src/cpu/difftest/ref.c" 3 4
...
__attribute__((visibility("default"))) void difftest_regcpy(void *dut, 
# 25 "src/cpu/difftest/ref.c" 3 4
                                        _Bool 
# 25 "src/cpu/difftest/ref.c"
                                             direction) {
  
# 26 "src/cpu/difftest/ref.c" 3 4
 ((void) sizeof ((
# 26 "src/cpu/difftest/ref.c"
 0
# 26 "src/cpu/difftest/ref.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 26 "src/cpu/difftest/ref.c"
...
# 30 "src/cpu/difftest/ref.c" 3 4
 ((void) sizeof ((
# 30 "src/cpu/difftest/ref.c"
 0
# 30 "src/cpu/difftest/ref.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 30 "src/cpu/difftest/ref.c"
