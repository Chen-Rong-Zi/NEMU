...
# 1 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h" 1
# 19 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h"
...
# 20 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h" 2
...
static inline word_t host_read(void *addr, int len) {
  switch (len) {
    ...
    ;
    default: 
# 27 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h" 3 4
            ((void) sizeof ((
# 27 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h"
            0
# 27 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h" 3 4
...
# 27 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h"
            "0"
# 27 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h" 3 4
            , "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h", 27, __extension__ __PRETTY_FUNCTION__); }))
# 27 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h"
                                                        ;
  }
}
...
static inline void host_write(void *addr, int len, word_t data) {
  switch (len) {
    ...
    ;
    default: 
# 37 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h" 3 4
   ((void) sizeof ((
# 37 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h"
   0
# 37 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 37 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h"
...
# 37 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h"
   "0"
# 37 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h" 3 4
   , "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h", 37, __extension__ __PRETTY_FUNCTION__); }))
# 37 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/host.h"
                                             ;
  }
}
...
# 1 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/device/mmio.h" 1
# 21 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/device/mmio.h"
...
static uint8_t pmem[0x20000000] __attribute((aligned(4096))) = {};
...
# 40 "src/memory/paddr.c" 3 4
 "x" 
# 40 "src/memory/paddr.c"
 "\33[0m" "\n", addr, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x20000000 - 1), cpu.pc)); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); 
# 40 "src/memory/paddr.c" 3 4
 ((void) sizeof ((
# 40 "src/memory/paddr.c"
 0
...
void init_mem() {
  ...
  memset(pmem, rand(), 0x20000000);
  do { printf("\33[1;34m" "[%s:%d %s] " "physical memory area [" "0x%08" 
# 50 "src/memory/paddr.c" 3 4
 "x" 
...
# 50 "src/memory/paddr.c" 3 4
 "x" 
# 50 "src/memory/paddr.c"
 "]" "\33[0m" "\n", "src/memory/paddr.c", 50, __func__, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x20000000 - 1)); do { extern FILE* log_fp; extern 
# 50 "src/memory/paddr.c" 3 4
 _Bool 
# 50 "src/memory/paddr.c"
...
# 50 "src/memory/paddr.c" 3 4
 ((void *)0)
# 50 "src/memory/paddr.c"
 ) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "physical memory area [" "0x%08" 
# 50 "src/memory/paddr.c" 3 4
 "x" 
# 50 "src/memory/paddr.c"
 ", " "0x%08" 
# 50 "src/memory/paddr.c" 3 4
 "x" 
# 50 "src/memory/paddr.c"
 "]" "\33[0m" "\n", "src/memory/paddr.c", 50, __func__, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x20000000 - 1)); fflush(log_fp); } } while (0); } while (0);
}
