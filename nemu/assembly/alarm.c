# 0 "src/device/alarm.c"
# 0 "<built-in>"
# 0 "<命令行>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<命令行>" 2
# 1 "src/device/alarm.c"
# 16 "src/device/alarm.c"
...
# 17 "src/device/alarm.c" 2
# 1 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/device/alarm.h" 1
# 21 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/device/alarm.h"
typedef void (*alarm_handler_t) ();
void add_alarm_handle(alarm_handler_t h);
# 18 "src/device/alarm.c" 2
...
# 20 "src/device/alarm.c" 2




# 23 "src/device/alarm.c"
...
# 27 "src/device/alarm.c"
 "idx < MAX_HANDLER"
# 27 "src/device/alarm.c" 3 4
 , "src/device/alarm.c", 27, __extension__ __PRETTY_FUNCTION__); }))
# 27 "src/device/alarm.c"
                          ;
  handler[idx ++] = h;
}
...
void init_alarm() {
  ...
  memset(&s, 0, sizeof(s));
  s.
# 41 "src/device/alarm.c" 3 4
   __sigaction_handler.sa_handler 
# 41 "src/device/alarm.c"
              = alarm_sig_handler;
  int ret = sigaction(
# 42 "src/device/alarm.c" 3 4
                     26
# 42 "src/device/alarm.c"
                              , &s, 
# 42 "src/device/alarm.c" 3 4
                                    ((void *)0)
# 42 "src/device/alarm.c"
  ...
  do { if (!(ret == 0)) { (fflush(
# 43 "src/device/alarm.c" 3 4
 stdout
# 43 "src/device/alarm.c"
 ), fprintf(
# 43 "src/device/alarm.c" 3 4
 stderr
# 43 "src/device/alarm.c"
 , "\33[1;31m" "Can not set signal handler" "\33[0m" "\n")); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); 
# 43 "src/device/alarm.c" 3 4
 ((void) sizeof ((
# 43 "src/device/alarm.c"
 ret == 0
...
# 43 "src/device/alarm.c"
 "ret == 0"
# 43 "src/device/alarm.c" 3 4
 , "src/device/alarm.c", 43, __extension__ __PRETTY_FUNCTION__); }))
# 43 "src/device/alarm.c"
 ; } } while (0);
  ...
  ret = setitimer(
# 49 "src/device/alarm.c" 3 4
                 ITIMER_VIRTUAL
# 49 "src/device/alarm.c"
                               , &it, 
# 49 "src/device/alarm.c" 3 4
                                      ((void *)0)
# 49 "src/device/alarm.c"
  ...
  do { if (!(ret == 0)) { (fflush(
# 50 "src/device/alarm.c" 3 4
 stdout
# 50 "src/device/alarm.c"
 ), fprintf(
# 50 "src/device/alarm.c" 3 4
 stderr
# 50 "src/device/alarm.c"
 , "\33[1;31m" "Can not set timer" "\33[0m" "\n")); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); 
# 50 "src/device/alarm.c" 3 4
 ((void) sizeof ((
# 50 "src/device/alarm.c"
 ret == 0
...
# 50 "src/device/alarm.c"
 "ret == 0"
# 50 "src/device/alarm.c" 3 4
 , "src/device/alarm.c", 50, __extension__ __PRETTY_FUNCTION__); }))
# 50 "src/device/alarm.c"
 ; } } while (0);
}
