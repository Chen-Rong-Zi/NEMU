...
# 16 "src/isa/riscv32/inst.c" 2
# 1 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/cpu/ifetch.h" 1
# 18 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/cpu/ifetch.h"
# 1 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/vaddr.h" 1
# 21 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/memory/vaddr.h"
word_t vaddr_ifetch(vaddr_t addr, int len);
word_t vaddr_read(vaddr_t addr, int len);
void vaddr_write(vaddr_t addr, int len, word_t data);
# 19 "/home/rongzi/.Lectures/term3/计算机系统基础/ProgrammingAssaignment/ics2024/nemu/include/cpu/ifetch.h" 2
...
# 24 "src/isa/riscv32/local-include/reg.h"
static inline int check_reg_idx(int idx) {
  
# 25 "src/isa/riscv32/local-include/reg.h" 3 4
 ((void) sizeof ((
# 25 "src/isa/riscv32/local-include/reg.h"
 idx >= 0 && idx < 32
# 25 "src/isa/riscv32/local-include/reg.h" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 25 "src/isa/riscv32/local-include/reg.h"
...
# 25 "src/isa/riscv32/local-include/reg.h" 3 4
 , "src/isa/riscv32/local-include/reg.h", 25, __extension__ __PRETTY_FUNCTION__); }))
# 25 "src/isa/riscv32/local-include/reg.h"
                                                                             ;
  return idx;
}
...
static inline word_t *check_csrs_idx(word_t idx){
    switch (idx) {
        ...
        default:
            do { if (!(
# 40 "src/isa/riscv32/local-include/reg.h" 3 4
           0
# 40 "src/isa/riscv32/local-include/reg.h"
           )) { (fflush(
# 40 "src/isa/riscv32/local-include/reg.h" 3 4
           stdout
# 40 "src/isa/riscv32/local-include/reg.h"
...
# 40 "src/isa/riscv32/local-include/reg.h" 3 4
           stderr
# 40 "src/isa/riscv32/local-include/reg.h"
           , "\33[1;31m" "get unkown vector index ""0x%08" 
# 40 "src/isa/riscv32/local-include/reg.h" 3 4
           "x" 
# 40 "src/isa/riscv32/local-include/reg.h"
           "\33[0m" "\n", idx)); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); 
# 40 "src/isa/riscv32/local-include/reg.h" 3 4
           ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail (
# 40 "src/isa/riscv32/local-include/reg.h"
           "0"
# 40 "src/isa/riscv32/local-include/reg.h" 3 4
           , "src/isa/riscv32/local-include/reg.h", 40, __extension__ __PRETTY_FUNCTION__); }))
# 40 "src/isa/riscv32/local-include/reg.h"
           ; } } while (0);
            return 
# 41 "src/isa/riscv32/local-include/reg.h" 3 4
                  ((void *)0)
# 41 "src/isa/riscv32/local-include/reg.h"
                      ;
    }
}
...
# 32 "src/isa/riscv32/inst.c"
static inline int show_all_reg_name() {
    for ( int i = 0; i < 32; i += 1 )
    {
        do { printf("\33[1;34m" "[%s:%d %s] " "%s(%d) : %d\n" "\33[0m" "\n", "src/isa/riscv32/inst.c", 35, __func__, reg_name(i), i, (cpu.gpr[check_reg_idx(i)])); do { extern FILE* log_fp; extern 
# 35 "src/isa/riscv32/inst.c" 3 4
       _Bool 
# 35 "src/isa/riscv32/inst.c"
       log_enable(); if (log_enable() && log_fp != 
# 35 "src/isa/riscv32/inst.c" 3 4
       ((void *)0)
# 35 "src/isa/riscv32/inst.c"
       ) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "%s(%d) : %d\n" "\33[0m" "\n", "src/isa/riscv32/inst.c", 35, __func__, reg_name(i), i, (cpu.gpr[check_reg_idx(i)])); fflush(log_fp); } } while (0); } while (0);
    }
    return 0;
}
...
static void decode_operand(Decode *s, int *rd, word_t *src1, word_t *src2, word_t *imm, int type) {
  ...
  *rd = (((i) >> (7)) & ((1ull << ((11) - (7) + 1)) - 1));
  switch (type) {
    ...
    case TYPE_J: do { *imm = ({ struct { int64_t n : 20; } __x = { .n = ((((i) >> (31)) & ((1ull << ((31) - (31) + 1)) - 1)) << 19 | (((i) >> (12)) & ((1ull << ((19) - (12) + 1)) - 1)) << 11 | (((i) >> (20)) & ((1ull << ((20) - (20) + 1)) - 1)) << 10 | (((i) >> (21)) & ((1ull << ((30) - (21) + 1)) - 1))) }; (uint64_t)__x.n; }) * 2; } while(0); break;
    case TYPE_R: do { *src1 = (cpu.gpr[check_reg_idx(rs1)]); } while (0); do { *src2 = (cpu.gpr[check_reg_idx(rs2)]); } while (0); ; break;
    case TYPE_B: do { *src1 = (cpu.gpr[check_reg_idx(rs1)]); } while (0); do { *src2 = (cpu.gpr[check_reg_idx(rs2)]); } while (0); do { *imm = ({ struct { int64_t n : 12; } __x = { .n = ((((i) >> (31)) & ((1ull << ((31) - (31) + 1)) - 1)) << 11 | (((i) >> (7)) & ((1ull << ((7) - (7) + 1)) - 1)) << 10 | (((i) >> (25)) & ((1ull << ((30) - (25) + 1)) - 1)) << 4 | (((i) >> (8)) & ((1ull << ((11) - (8) + 1)) - 1))) }; (uint64_t)__x.n; }) * 2; } while(0); break;
  }
}
...
# 102 "src/isa/riscv32/inst.c"
  ...
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? ??? ????? 01101 11", (sizeof("??????? ????? ????? ??? ????? 01101 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_U); (cpu.gpr[check_reg_idx(rd)]) = imm ; ;; }; goto *(__instpat_end); } } while (0);
  ...
  do { uint64_t key, mask, shift; pattern_decode("???????????? ????? 000 ????? 11001 11", (sizeof("???????????? ????? 000 ????? 11001 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = s->snpc; s->dnpc = imm + src1;ftrace_print(imm + src1, ((imm == 0) && (rd == 0)) ? 1 : 0); ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("???????????? ????? 101 ????? 00000 11", (sizeof("???????????? ????? 101 ????? 00000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = ((u16)(vaddr_read(src1 + imm, 2))); ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("???????????? ????? 000 ????? 00000 11", (sizeof("???????????? ????? 000 ????? 00000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = ((i8)(vaddr_read(src1 + imm, 1))); ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("???????????? ????? 001 ????? 00000 11", (sizeof("???????????? ????? 001 ????? 00000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = ((i16)(vaddr_read(src1 + imm, 2))); ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("???????????? ????? 010 ????? 00000 11", (sizeof("???????????? ????? 010 ????? 00000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = ((i32)(vaddr_read(src1 + imm, 4))); ; ;; }; goto *(__instpat_end); } } while (0);

  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 000 ????? 00100 11", (sizeof("??????? ????? ????? 000 ????? 00100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = src1 + imm; ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 011 ????? 00100 11", (sizeof("??????? ????? ????? 011 ????? 00100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = ((u32)(src1)) < ((u32)(imm)) ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 010 ????? 00100 11", (sizeof("??????? ????? ????? 010 ????? 00100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = ((i32)(src1)) < ((i32)(imm)) ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 100 ????? 00100 11", (sizeof("??????? ????? ????? 100 ????? 00100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = src1 ^ imm; ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 111 ????? 00100 11", (sizeof("??????? ????? ????? 111 ????? 00100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = src1 & imm; ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 110 ????? 00100 11", (sizeof("??????? ????? ????? 110 ????? 00100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = src1 | imm; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 001 ????? 00100 11", (sizeof("0000000 ????? ????? 001 ????? 00100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = src1 << imm; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 101 ????? 00100 11", (sizeof("0000000 ????? ????? 101 ????? 00100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = ((u32)(src1)) >> imm; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0100000 ????? ????? 101 ????? 00100 11", (sizeof("0100000 ????? ????? 101 ????? 00100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = ((i32)(src1)) >> imm; ; ; ;; }; goto *(__instpat_end); } } while (0);

  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 000 ????? 01100 11", (sizeof("0000000 ????? ????? 000 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 + src2; ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000001 ????? ????? 000 ????? 01100 11", (sizeof("0000001 ????? ????? 000 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 * src2; ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0100000 ????? ????? 000 ????? 01100 11", (sizeof("0100000 ????? ????? 000 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 - src2; ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000001 ????? ????? 001 ????? 01100 11", (sizeof("0000001 ????? ????? 001 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = (((({ struct { int64_t n : 32; } __x = { .n = src1 }; (uint64_t)__x.n; }) * ({ struct { int64_t n : 32; } __x = { .n = src2 }; (uint64_t)__x.n; })) >> (32)) & ((1ull << ((63) - (32) + 1)) - 1)); ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000001 ????? ????? 011 ????? 01100 11", (sizeof("0000001 ????? ????? 011 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = (((((u64)(src1)) * ((u64)(src2))) >> (32)) & ((1ull << ((63) - (32) + 1)) - 1)); ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 010 ????? 01100 11", (sizeof("0000000 ????? ????? 010 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = ((i32)(src1)) < ((i32)(src2)); ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 011 ????? 01100 11", (sizeof("0000000 ????? ????? 011 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = ((u32)(src1)) < ((u32)(src2)); ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 100 ????? 01100 11", (sizeof("0000000 ????? ????? 100 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 ^ src2; ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000001 ????? ????? 100 ????? 01100 11", (sizeof("0000001 ????? ????? 100 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = (src2 == 0)? -1 : (( src1 == ((i32)(2147483648)) && src2 == ((i32)(-1)) )? src1 : ((i32)(src1)) / ((i32)(src2))) ; ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000001 ????? ????? 101 ????? 01100 11", (sizeof("0000001 ????? ????? 101 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = (src2 == 0)? ((u32)(-1)) : (((u32)(src1)) / ((u32)(src2))) ; ;; }; goto *(__instpat_end); } } while (0) ; ;;
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 101 ????? 01100 11", (sizeof("0000000 ????? ????? 101 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = ((u32)(src1)) >> (((src2) >> (0)) & ((1ull << ((4) - (0) + 1)) - 1)); ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0100000 ????? ????? 101 ????? 01100 11", (sizeof("0100000 ????? ????? 101 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = ((i32)(src1)) >> (((src2) >> (0)) & ((1ull << ((4) - (0) + 1)) - 1)); ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 001 ????? 01100 11", (sizeof("0000000 ????? ????? 001 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 << (((src2) >> (0)) & ((1ull << ((4) - (0) + 1)) - 1)); ; ; ;; }; goto *(__instpat_end); } } while (0);

  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 110 ????? 01100 11", (sizeof("0000000 ????? ????? 110 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 | src2; ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000001 ????? ????? 110 ????? 01100 11", (sizeof("0000001 ????? ????? 110 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = (src2 == 0)? (src1) : (( src1 == ((i32)(2147483648)) && src2 == ((i32)(-1)) )? 0 : (((i32)(src1)) % ((i32)(src2)))) ; ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000001 ????? ????? 111 ????? 01100 11", (sizeof("0000001 ????? ????? 111 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = (src2 == 0)? (src1) : (((u32)(src1)) % ((u32)(src2))) ; ; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 111 ????? 01100 11", (sizeof("0000000 ????? ????? 111 ????? 01100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 & src2; ; ; ;; }; goto *(__instpat_end); } } while (0);

  do { uint64_t key, mask, shift; pattern_decode("????????????????????   ????? 11011 11", (sizeof("????????????????????   ????? 11011 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_J); (cpu.gpr[check_reg_idx(rd)]) = s->snpc; s->dnpc = imm + s->pc; ftrace_print(imm + s->pc, 0);;; ; ;; }; goto *(__instpat_end); } } while (0);

  do { uint64_t key, mask, shift; pattern_decode("?????????????????  000 ????? 11000 11", (sizeof("?????????????????  000 ????? 11000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_B); if ( src1 == src2 ) {s->dnpc = imm + s->pc; ;;} else {;;}; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("?????????????????  001 ????? 11000 11", (sizeof("?????????????????  001 ????? 11000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_B); if ( src1 != src2 ) { s->dnpc = imm + s->pc; ;; } else { ;; }; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("?????????????????  100 ????? 11000 11", (sizeof("?????????????????  100 ????? 11000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_B); if ( ((i32)(src1)) < ((i32)(src2)) ) {s->dnpc = imm + s->pc; ;;} else {;;}; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("?????????????????  101 ????? 11000 11", (sizeof("?????????????????  101 ????? 11000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_B); if ( ((i32)(src1)) >= ((i32)(src2)) ) {s->dnpc = imm + s->pc; ;;} else {;;}; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("?????????????????  110 ????? 11000 11", (sizeof("?????????????????  110 ????? 11000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_B); if ( ((u32)(src1)) < ((u32)(src2)) ) {s->dnpc = imm + s->pc; ;;} else {;;}; ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("?????????????????  111 ????? 11000 11", (sizeof("?????????????????  111 ????? 11000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_B); if ( ((u32)(src1)) >= ((u32)(src2)) ) {s->dnpc = imm + s->pc; ;;} else {;;}; ; ;; }; goto *(__instpat_end); } } while (0);
  ...
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 001 ????? 01000 11", (sizeof("??????? ????? ????? 001 ????? 01000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_S); vaddr_write(src1 + imm, 2, src2) ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 010 ????? 01000 11", (sizeof("??????? ????? ????? 010 ????? 01000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_S); vaddr_write(src1 + imm, 4, src2) ; ;; }; goto *(__instpat_end); } } while (0);

  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 001 ????? 11100 11", (sizeof("??????? ????? ????? 001 ????? 11100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = (*(check_csrs_idx(imm))); (*(check_csrs_idx(imm))) = src1 ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 010 ????? 11100 11", (sizeof("??????? ????? ????? 010 ????? 11100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = (*(check_csrs_idx(imm))); (*(check_csrs_idx(imm))) = src1 | (*(check_csrs_idx(imm))) ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 011 ????? 11100 11", (sizeof("??????? ????? ????? 011 ????? 11100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = (*(check_csrs_idx(imm))); (*(check_csrs_idx(imm))) = (~src1) & (*(check_csrs_idx(imm))) ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 101 ????? 11100 11", (sizeof("??????? ????? ????? 101 ????? 11100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = (*(check_csrs_idx(imm))); (*(check_csrs_idx(imm))) = src1 ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 110 ????? 11100 11", (sizeof("??????? ????? ????? 110 ????? 11100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = (*(check_csrs_idx(imm))); (*(check_csrs_idx(imm))) = src1 | (*(check_csrs_idx(imm))) ; ;; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 111 ????? 11100 11", (sizeof("??????? ????? ????? 111 ????? 11100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = (*(check_csrs_idx(imm))); (*(check_csrs_idx(imm))) = (~src1) | (*(check_csrs_idx(imm))) ; ;; }; goto *(__instpat_end); } } while (0);


  do { uint64_t key, mask, shift; pattern_decode("0000000 00000 00000 000 00000 11100 11", (sizeof("0000000 00000 00000 000 00000 11100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_N); s->dnpc = isa_raise_intr((cpu.gpr[check_reg_idx(17)]), s->dnpc);;; ; ;; }; goto *(__instpat_end); } } while (0);
  ...
  do { uint64_t key, mask, shift; pattern_decode("0011000 00010 00000 000 00000 11100 11", (sizeof("0011000 00010 00000 000 00000 11100 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst.val) >> shift) & mask) == key) { { decode_operand(s, &rd, &src1, &src2, &imm, TYPE_N); s->dnpc = cpu.csrs.mepc;do { printf("\33[1;34m" "[%s:%d %s] " "goto 0x%x" "\33[0m" "\n", "src/isa/riscv32/inst.c", 167, __func__, s->dnpc); do { extern FILE* log_fp; extern 
# 167 "src/isa/riscv32/inst.c" 3 4
 _Bool 
# 167 "src/isa/riscv32/inst.c"
 log_enable(); if (log_enable() && log_fp != 
# 167 "src/isa/riscv32/inst.c" 3 4
 ((void *)0)
# 167 "src/isa/riscv32/inst.c"
 ) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "goto 0x%x" "\33[0m" "\n", "src/isa/riscv32/inst.c", 167, __func__, s->dnpc); fflush(log_fp); } } while (0); } while (0); ; ;; }; goto *(__instpat_end); } } while (0);
